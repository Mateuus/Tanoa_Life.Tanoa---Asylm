...
[] spawn
{
	...
	if(_id == 31 && 126 in life_talents) exitWith {hint "You can not learn marksman while having the master bounty hunter talent."};
	if(_id == 126 && 31 in life_talents) exitWith {hint "You must first unlearn the marksman talent to become a master bounty hunter."};
