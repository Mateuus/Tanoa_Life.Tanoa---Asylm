...
_items = switch (_shop) do
{
	...
	case "market": {[format["%1 Market", worldName],["water","apple","peach","beer","redgull","tbacon","painkillers","yeast","woodaxe","shovel","skinningknife","campfire","tent1","tent2","fuelF","pickaxe","phos","hydro","excavator","caralarm","protest"],["water","rabbit","apple","peach","chicken","chickenp","snake","snakep","rabbitp","goat","goatp","sheep","sheepp","redgull","tbacon","painkillers","yeast","towRope","skinningknife","timber","campfire","tent1","tent2","fuelF","pickaxe","phos","hydro","excavator","caralarm","protest","berry","banana","ginger","plank","sugar","sugarcane"]]};
