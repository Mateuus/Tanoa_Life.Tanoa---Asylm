...
[[(getPlayerUID player),playerSide,_vehicle,_color,player,_plate,_fuel,_damage,(87 in life_talents),_insured],"ASY_fnc_vehicleCreate",false,false] spawn life_fnc_MP;
