...
[] spawn {
	...
	profileNamespace setVariable["ASYsettings",[tawvd_foot,tawvd_car,tawvd_air,life_ringer,life_adminReq]];
};
...
{
	(profileNamespace getVariable["ASYsettings",[1600,1600,1600,true,false]]) select 3;
};
